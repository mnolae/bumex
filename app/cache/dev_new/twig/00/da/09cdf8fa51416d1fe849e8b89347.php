...
class __TwigTemplate_00da09cdf8fa51416d1fe849e8b89347 extends Twig_Template
{
    ...
    ") ? '' : new Twig_Markup($tmp, $this->env->getCharset());
        ...
        echo "            <span style=\"margin: 0; padding: 0; color: #979696;\">|</span>
            <span";
        // line 18
        echo (((!$this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "route"))) ? (" style=\"color:#a33\"") : (""));
        echo ">";
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "route")) ? ($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "route")) : ("NONE")), "html", null, true);
        echo "</span>
            <span style=\"margin: 0; padding: 0; color: #979696;\">|</span>
            <span style=\"color: ";
        // line 20
        echo (((200 == $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "statuscode"))) ? ("#759e1a") : ("#a33"));
        echo "\">";
...
";
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestquery"), "all"))) {
            // line 37
            echo "        ";
            $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestquery")));
            // line 38
            echo "    ";
        } else {
            // line 39
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestrequest"), "all"))) {
            // line 47
            echo "        ";
            $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestrequest")));
            // line 48
            echo "    ";
        } else {
            // line 49
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestattributes"), "all"))) {
            // line 57
            echo "        ";
            $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestattributes")));
            // line 58
            echo "    ";
        } else {
            // line 59
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestcookies"), "all"))) {
            // line 67
            echo "        ";
            $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestcookies")));
            // line 68
            echo "    ";
        } else {
            // line 69
    ...
    ";
        // line 76
        $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestheaders")));
        // line 77
        echo "
    ...
    ";
        // line 90
        $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "requestserver")));
        // line 91
        echo "
    ...
    ";
        // line 94
        $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "responseheaders")));
        // line 95
        echo "
    ...
    ";
        ...
        if (twig_length_filter($this->env, $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "sessionattributes"))) {
            ...
            <tbody>
                ";
            // line 107
            $context["attributes"] = $this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "sessionattributes");
            // line 108
            echo "                ";
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable(twig_sort_filter(twig_get_array_keys_filter((isset($context["attributes"]) ? $context["attributes"] : null))));
            foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
                ...
                echo "</th>
                        <td>";
                // line 111
                echo twig_escape_filter($this->env, $this->env->getExtension('yaml')->dump($this->getAttribute((isset($context["attributes"]) ? $context["attributes"] : null), (isset($context["key"]) ? $context["key"] : null), array(), "array")), "html", null, true);
                echo "</td>
                    </tr>
                ";
            }
    ...
    ";
        ...
        ";
            // line 126
            $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["profile"]) ? $context["profile"] : null), "parent"), "getcollector", array(0 => "request"), "method"), "requestattributes")));
            // line 127
            echo "    ";
        }
        // line 128
    ...
    ";
        ...
        ";
            ...
            ";
                // line 134
                $this->env->loadTemplate("WebProfilerBundle:Profiler:bag.html.twig")->display(array("bag" => $this->getAttribute($this->getAttribute((isset($context["child"]) ? $context["child"] : null), "getcollector", array(0 => "request"), "method"), "requestattributes")));
                // line 135
                echo "        ";
            }
            $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  332 => 137,  329 => 136,  323 => 135,  321 => 134,  314 => 133,  310 => 132,  306 => 130,  304 => 129,  301 => 128,  298 => 127,  296 => 126,  288 => 124,  286 => 123,  282 => 121,  276 => 117,  271 => 114,  262 => 111,  258 => 110,  255 => 109,  250 => 108,  248 => 107,  238 => 99,  236 => 98,  231 => 95,  229 => 94,  222 => 90,  217 => 87,  213 => 85,  207 => 83,  203 => 81,  201 => 80,  194 => 76,  183 => 69,  180 => 68,  175 => 66,  164 => 59,  118 => 36,  170 => 63,  157 => 55,  151 => 53,  140 => 52,  100 => 27,  45 => 9,  154 => 54,  150 => 43,  119 => 47,  66 => 15,  68 => 20,  65 => 22,  136 => 40,  114 => 34,  21 => 3,  76 => 39,  56 => 14,  138 => 37,  130 => 48,  106 => 26,  98 => 21,  85 => 28,  61 => 17,  36 => 5,  105 => 36,  101 => 22,  209 => 84,  205 => 82,  196 => 77,  192 => 78,  189 => 73,  178 => 71,  176 => 70,  165 => 63,  161 => 58,  152 => 58,  148 => 57,  145 => 49,  141 => 55,  134 => 50,  132 => 43,  127 => 46,  123 => 38,  109 => 37,  93 => 33,  90 => 36,  54 => 13,  133 => 49,  124 => 41,  111 => 33,  80 => 29,  60 => 16,  52 => 13,  26 => 3,  72 => 17,  64 => 35,  53 => 23,  42 => 8,  34 => 5,  97 => 26,  95 => 47,  88 => 32,  78 => 26,  71 => 21,  40 => 9,  25 => 5,  92 => 23,  86 => 28,  79 => 28,  29 => 5,  19 => 2,  23 => 29,  224 => 91,  215 => 90,  211 => 88,  204 => 84,  200 => 83,  195 => 80,  193 => 79,  190 => 78,  188 => 77,  185 => 76,  179 => 72,  177 => 67,  171 => 67,  162 => 63,  158 => 57,  156 => 56,  153 => 59,  146 => 55,  142 => 48,  137 => 46,  126 => 39,  120 => 37,  117 => 44,  103 => 28,  74 => 38,  47 => 11,  32 => 6,  24 => 3,  22 => 3,  17 => 1,  69 => 21,  63 => 28,  58 => 16,  49 => 16,  43 => 12,  37 => 5,  20 => 2,  139 => 47,  131 => 48,  128 => 43,  125 => 36,  121 => 40,  115 => 39,  107 => 36,  99 => 34,  96 => 34,  91 => 31,  82 => 20,  77 => 24,  75 => 18,  57 => 27,  50 => 12,  46 => 13,  44 => 10,  39 => 12,  33 => 7,  30 => 4,  27 => 3,  135 => 41,  129 => 38,  122 => 46,  116 => 33,  113 => 43,  108 => 28,  104 => 40,  102 => 6,  94 => 32,  89 => 22,  87 => 44,  84 => 29,  81 => 29,  73 => 23,  70 => 24,  67 => 17,  62 => 22,  59 => 21,  55 => 20,  51 => 17,  48 => 10,  41 => 9,  38 => 8,  35 => 7,  31 => 4,  28 => 3,);
    }
}
